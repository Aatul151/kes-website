  ...
  return (
    <div className="page-transition pt-20">
      ...
      <HeroSection
        ...
        title="Our Projects"
        description={`${COMPANY.projectsDelivered}+ projects delivered across India's most demanding industrial sectors. Here are some of our landmark achievements.`}
      />
        ...
        <section className="py-14 bg-[#F8F8F8]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between pb-3">
              ...
              <button
                className="btn-outline px-2 text-xs shrink-0"
                        ...
                        <div className="flex items-center gap-3 text-gray-400 text-[11px]">
                          {project.area && (
                            <span className="flex items-center gap-1">
                              <Maximize2 size={10} /> {project.area}
                            </span>
                          )}
                          {project.year && (
                            <span className="flex items-center gap-1">
      ...
      {allImages && allImages?.length > 0 && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-start p-6 pt-[150px] justify-center w-[100vw]">
          <div
      ...
      <section className="py-16 bg-[#C8102E]">
        <div className="max-w-4xl mx-auto px-4 text-center animate-on-scroll">
          ...
          <p className="text-red-100 text-sm mb-7">
            Join {COMPANY.satisfiedClients}+ satisfied clients who trust KES Engineering for their
